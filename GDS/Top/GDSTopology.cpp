// ======================================================================
// \title  GDSTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <GDS/Top/GDSTopologyAc.hpp>
#include <GDS/Top/GDSPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(GDSPacketsPkts, GDSPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name GDS
namespace GDS {
