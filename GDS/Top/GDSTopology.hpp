// ======================================================================
// \title  GDSTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef GDS_GDSTOPOLOGY_HPP
#define GDS_GDSTOPOLOGY_HPP
// Included for access to GDS::TopologyState and GDS::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <GDS/Top/GDSTopologyDefs.hpp>

// Remove unnecessary GDS:: qualifications
using namespace GDS;
namespace GDS {
/**
 ...
 * GDS::TopologyState see: GDSTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type GDS::TopologyState see: GDSTopologyDefs.hpp.
 *
