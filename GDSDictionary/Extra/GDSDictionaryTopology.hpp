// // ======================================================================
// // \title  GDSDictionaryTopology.hpp
// // \brief header file containing the topology instantiation definitions
// //
// // ======================================================================
// #ifndef GDSDICTIONARY_GDSDICTIONARYTOPOLOGY_HPP
// #define GDSDICTIONARY_GDSDICTIONARYTOPOLOGY_HPP
// // Included for access to GDSDictionary::TopologyState and GDSDictionary::ConfigObjects::pingEntries. These definitions are required by the
// // autocoder, but are also used in this hand-coded topology.
// #include <GDSDictionary/Top/GDSDictionaryTopologyDefs.hpp>

// // Remove unnecessary GDSDictionary:: qualifications
// using namespace GDSDictionary;
...
//  * GDSDictionary::TopologyState see: GDSDictionaryTopologyDefs.hpp.
//  *
...
//  *
//  * For an explanation of the required type GDSDictionary::TopologyState see: GDSDictionaryTopologyDefs.hpp.
//  *
