// ======================================================================
// \title  obcATopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef OBCA_OBCATOPOLOGY_HPP
#define OBCA_OBCATOPOLOGY_HPP
// Included for access to obcA::TopologyState and obcA::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <obcA/Top/obcATopologyDefs.hpp>

// Remove unnecessary obcA:: qualifications
 ...
 * obcA::TopologyState see: obcATopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type obcA::TopologyState see: obcATopologyDefs.hpp.
 *
