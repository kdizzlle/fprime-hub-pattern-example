...
int main(int argc, char* argv[]) {
    ...
    obcA::setupTopology(inputs);
    obcA::startSimulatedCycle(Fw::Time(1, 0));  // Program loop cycling rate groups at 1Hz
    obcA::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
