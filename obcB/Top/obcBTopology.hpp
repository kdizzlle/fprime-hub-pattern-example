// ======================================================================
// \title  obcBTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef OBCB_OBCBTOPOLOGY_HPP
#define OBCB_OBCBTOPOLOGY_HPP
// Included for access to obcB::TopologyState and obcB::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <obcB/Top/obcBTopologyDefs.hpp>

// Remove unnecessary obcB:: qualifications
 ...
 * obcB::TopologyState see: obcBTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type obcB::TopologyState see: obcBTopologyDefs.hpp.
 *
